"""
Data source abstraction for the Gold Engine.
...
YFINANCE_TICKERS: Dict[str, str] = {
    ...
    "ief":    "IEF",          # 7-10Y Treasury bond ETF (price proxy for yields)
    "silver": "SI=F",         # Silver futures
    "sp500":  "SPY",          # S&P 500 ETF proxy
    "eurusd": "EURUSD=X",     # EUR/USD
    "vix":    "^VIX",         # VIX index
    "gold":   "GC=F",         # Gold futures (target)
}
