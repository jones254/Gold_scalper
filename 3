...
Mirrors the DE40 engine architecture but swaps the market panel
and sign-inversion logic to match gold's macro drivers.
"""
...
# Markets that are NEGATIVELY correlated with Gold in the model.
